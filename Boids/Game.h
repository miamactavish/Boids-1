...
private:
	...
	vector<sf::CircleShape> obstacles;
	...
	void Render(sf::Text text, float fps, sf::Text text4, 
	...
	void createBoid(float x, float y, sf::Color fillColor, sf::Color outlineColor);
	void HandleInput();
